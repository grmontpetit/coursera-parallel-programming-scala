...
object LineOfSight {
  ...
  /**
    * Implement the sequential lineOfSight method,
    * which, for each height entry in the input array
    * (except for input(0) which is the location of
    * the observer and is always zero), writes the
    * maximum angle until that point into the output
